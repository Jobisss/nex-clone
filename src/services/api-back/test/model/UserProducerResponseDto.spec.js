...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.UserProducerResponseDto();
  });
  ...
  describe('UserProducerResponseDto', function() {
    it('should create an instance of UserProducerResponseDto', function() {
      // uncomment below and update the code to test UserProducerResponseDto
      //var instance = new NexEventApi.UserProducerResponseDto();
      //expect(instance).to.be.a(NexEventApi.UserProducerResponseDto);
    });
