...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.EventProducerUpdateDto();
  });
  ...
  describe('EventProducerUpdateDto', function() {
    it('should create an instance of EventProducerUpdateDto', function() {
      // uncomment below and update the code to test EventProducerUpdateDto
      //var instance = new NexEventApi.EventProducerUpdateDto();
      //expect(instance).to.be.a(NexEventApi.EventProducerUpdateDto);
    });
