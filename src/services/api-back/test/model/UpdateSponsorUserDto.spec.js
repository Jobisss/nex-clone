...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.UpdateSponsorUserDto();
  });
  ...
  describe('UpdateSponsorUserDto', function() {
    it('should create an instance of UpdateSponsorUserDto', function() {
      // uncomment below and update the code to test UpdateSponsorUserDto
      //var instance = new NexEventApi.UpdateSponsorUserDto();
      //expect(instance).to.be.a(NexEventApi.UpdateSponsorUserDto);
    });
