...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.EventAllResponseDtoInner();
  });
  ...
  describe('EventAllResponseDtoInner', function() {
    it('should create an instance of EventAllResponseDtoInner', function() {
      // uncomment below and update the code to test EventAllResponseDtoInner
      //var instance = new NexEventApi.EventAllResponseDtoInner();
      //expect(instance).to.be.a(NexEventApi.EventAllResponseDtoInner);
    });
