...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.EventStaffAllResponseDtoInner();
  });
  ...
  describe('EventStaffAllResponseDtoInner', function() {
    it('should create an instance of EventStaffAllResponseDtoInner', function() {
      // uncomment below and update the code to test EventStaffAllResponseDtoInner
      //var instance = new NexEventApi.EventStaffAllResponseDtoInner();
      //expect(instance).to.be.a(NexEventApi.EventStaffAllResponseDtoInner);
    });
