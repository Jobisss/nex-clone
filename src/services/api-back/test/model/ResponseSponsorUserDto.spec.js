...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.ResponseSponsorUserDto();
  });
  ...
  describe('ResponseSponsorUserDto', function() {
    it('should create an instance of ResponseSponsorUserDto', function() {
      // uncomment below and update the code to test ResponseSponsorUserDto
      //var instance = new NexEventApi.ResponseSponsorUserDto();
      //expect(instance).to.be.a(NexEventApi.ResponseSponsorUserDto);
    });
