...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.GetEventConfigDto();
  });
  ...
  describe('GetEventConfigDto', function() {
    it('should create an instance of GetEventConfigDto', function() {
      // uncomment below and update the code to test GetEventConfigDto
      //var instance = new NexEventApi.GetEventConfigDto();
      //expect(instance).to.be.a(NexEventApi.GetEventConfigDto);
    });
