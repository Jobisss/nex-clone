...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.FindByFacialResponseDtoTicketsInner();
  });
  ...
  describe('FindByFacialResponseDtoTicketsInner', function() {
    it('should create an instance of FindByFacialResponseDtoTicketsInner', function() {
      // uncomment below and update the code to test FindByFacialResponseDtoTicketsInner
      //var instance = new NexEventApi.FindByFacialResponseDtoTicketsInner();
      //expect(instance).to.be.a(NexEventApi.FindByFacialResponseDtoTicketsInner);
    });
