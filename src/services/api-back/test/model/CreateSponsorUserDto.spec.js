...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexEventApi.CreateSponsorUserDto();
  });
  ...
  describe('CreateSponsorUserDto', function() {
    it('should create an instance of CreateSponsorUserDto', function() {
      // uncomment below and update the code to test CreateSponsorUserDto
      //var instance = new NexEventApi.CreateSponsorUserDto();
      //expect(instance).to.be.a(NexEventApi.CreateSponsorUserDto);
    });
